...
class BinaryTree:
    ...
    def IF_LEFT_AND_RIGHT(self, node):
        ...
        #Define variable "delNodeParent" with the value "node", responsible for storing parent node to be deleted
        #Define variable "delNode" with right child node of current node, responsible for storing child node to be deleted
        delNodeParent = node
        delNode = node.right
    ...
    def remove(self, target):
        ...
        #Define variable "parent" with value "None", responsible for storing parent of current node
        parent = None
        #Define variable "node" with value "self.root", responsible for storing current node
        node = self.root
