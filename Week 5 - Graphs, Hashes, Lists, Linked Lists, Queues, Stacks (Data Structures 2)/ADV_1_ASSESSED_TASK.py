...
class BinaryTree:
    ...
    #"self" =  Instance of "BinaryTree" object class the method is called from is the argument, 
    ...
    #"self" =  Instance of "BinaryTree" object class the method is called from is the argument,
    #"target" = Value to search for in instance of "BinaryTree" object class
    def remove(self, target):
        ...
        while node and node.data != target:                     #While "node" exists and "node" value not equal to "target", execute "while" code block
...
bst.display(bst.root)                                           #Print binary tree of "bst" instance of "BinaryTree" object class using "display" method (Before node removal)
bst.remove(3)                                                   #Test iterative "remove" method with value present in "bst" instance of "BinaryTree" object class
bst.display(bst.root)                                           #Print binary tree of "bst" instance of "BinaryTree" object class using "display" method (After node removal)